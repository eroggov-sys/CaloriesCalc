...
namespace api.Migrations
{
    ...
    [Migration("20260919133137_AddFoodSourceAndBarcode")]
    partial class AddFoodSourceAndBarcode
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.UserProfile", b =>
                {
                    ...
                    b.ToTable("UserProfiles", t =>
                        {
                            t.HasCheckConstraint("CK_UserProfile_WeightKg", "\"WeightKg\" >= 20 AND \"WeightKg\" <= 500");

                            t.HasCheckConstraint("CK_UserProfiles_BodyFatPercentage", "\"BodyFatPercentage\" IS NULL OR (\"BodyFatPercentage\" >= 1 AND \"BodyFatPercentage\" <= 75)");

                            t.HasCheckConstraint("CK_UserProfiles_HeightCm", "\"HeightCm\" >= 50 AND \"HeightCm\" <= 300");
                        });
                });
